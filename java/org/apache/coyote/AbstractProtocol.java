...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
    ...
    protected static class ConnectionHandler<S> implements AbstractEndpoint.Handler<S> {
        ...
        public SocketState process(SocketWrapperBase<S> wrapper, SocketEvent status) {
            ...
            // We take complete ownership of the Processor inside of this method to ensure no other thread can release it while we're using it.
            // Whatever processor is held by this variable will be associated with the SocketWrapper before this method returns.
            ...
            // Timeouts are calculated on a dedicated thread and then dispatched.
            // Because of delays in the dispatch process, the timeout may no longer be required.
            // Check here and avoid unnecessary processing.
